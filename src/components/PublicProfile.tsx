  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans pb-24 relative">
      ...
      <main className="max-w-4xl mx-auto px-4 pt-6 space-y-8">
        ...
        {/* Visiting Card Contact Details Card */}
        <div id="visiting-card-details" className="bg-slate-900 border border-slate-800 rounded-3xl p-6 sm:p-8 space-y-6 shadow-xl">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-4 border-b border-slate-800">
            <div className="space-y-1">
              <div className="flex items-center space-x-2">
                <CreditCard className="w-6 h-6 text-blue-400" />
                <h2 className="text-xl font-bold text-white">Visiting Card & Contact Details</h2>
              </div>
              <p className="text-xs text-slate-400">
                Official verified business contact information extracted from visiting card
              </p>
            </div>
            <div className="flex items-center space-x-2">
              <span className="px-3 py-1 bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 rounded-full text-xs font-semibold flex items-center space-x-1.5">
                <UserCheck className="w-3.5 h-3.5" />
                <span>Verified Visiting Card</span>
              </span>
            </div>
          </div>
